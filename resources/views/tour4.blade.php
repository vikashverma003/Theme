            ...
            <div class="row">
               	<div class="col-sm-12 main-section">
					<!-- <iframe src="https://www.google.com/maps/embed?pb=!4v1541827602396!6m8!1m7!1sCAoSLEFGMVFpcE5QUTg4X1lXVC1kbGtmdVZUQnpzU1lSZUNCd2tjeUk2QVRiZnF5!2m2!1d40.7525622!2d-73.9931179!3f251.62602693056294!4f-6.717542851739168!5f0.7820865974627469" width="100%" height="520" frameborder="0" style="border:0" allowfullscreen></iframe> -->
						...
						<img src="/imgs/utty_1544708032_jpg" style="width:1900px; height:400px; ">
				</div>
			 	<!-- COL-SM-12 END -->
			</div>
	</div>
            ...
            <div class="row">			
               	<div class="col-sm-6">
                    <div class="side_img">
							...
							<img src="imgs/utty1_1544708032_jpg"> 
			 	...
			 	<div class="col-sm-6 ">
                    <div class="side_div">
							<div class="new_heading">
								<h2> <span class="span_main_1"></span>kattarasar<span class="span_main_2"></span></h2>
							</div>
                            <p class="para_left">
			...
			<div class="row">			
			 	...
			 	<div class="col-sm-6 ">
                    <div class="side_div paddinG-side">
                   	...
                   	<div class="col-sm-6">
                    <div class="side_img">
							<img src="imgs/utty2_1544708032_jpg" class="img-responsive grid_image">
                    </div>
				</div>
    ...
    <div class="pagination_div">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-3"><img src="imgs/ladak_1544772951_jpg" class="img-responsive paginaton"></div>
				<div class="col-sm-3"><img src="imgs/ladak1_1544772951_jpg" class="img-responsive paginaton"></div>
				<div class="col-sm-3"><img src="imgs/ladak3_1544772951_jpg" class="img-responsive paginaton"></div>
                <div class="col-sm-3"><img src="imgs/ladak4_1544772972_jpg" class="img-responsive paginaton"></div>
                </div>
			</div>
			<!-- <div class="row">
                  <div class="main_desti_img clearfix">
