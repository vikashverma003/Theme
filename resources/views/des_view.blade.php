            ...
            <div class="row">
               	...
               	<div class="col-sm-12 main-section">
					...
					<!-- <iframe src="https://www.google.com/maps/embed?pb=!4v1541827602396!6m8!1m7!1sCAoSLEFGMVFpcE5QUTg4X1lXVC1kbGtmdVZUQnpzU1lSZUNCd2tjeUk2QVRiZnF5!2m2!1d40.7525622!2d-73.9931179!3f251.62602693056294!4f-6.717542851739168!5f0.7820865974627469" width="100%" height="520" frameborder="0" style="border:0" allowfullscreen></iframe>  -->
							...
							@foreach($data as $da)
					 <img src="{{asset('/imgs/') }}/{{$da->destination}}" style="width:100%; height:520px;">
            ...
            <div class="row">	
               	...
               	<div class="col-sm-6">
                    ...
                    <div class="side_img">
						...
						<div class="col-sm-3"><a href="/sub/{{$imgs->id}}"><img src="{{asset('/imgs/') }}/{{$imgs->image}}" style="width:300px; height:300px;"></a></div>

						<!--  -->
			

							<!-- <img src="images/desti.jpg"> -->
			 	...
			 	<div class="col-sm-6 ">
                    <div class="side_div">
							...
							<div class="new_heading">
								<h2> <span class="span_main_1"></span>{{$imgs->name1}}<span class="span_main_2"></span></h2>
							</div>
			...
			<div class="row">			
			 	...
			 	<div class="col-sm-6 ">
                    <div class="side_div paddinG-side">
							<div class="new_heading">
								<h2> <span class="span_main_1"></span>Lorem Ipsum<span class="span_main_2 span_main_4"></span></h2>
							</div>
                   	...
                   	<div class="col-sm-6">
                    <div class="side_img">
							<img src="images/desti.jpg" class="img-responsive grid_image">
                    </div>
				</div>
...
<div class="col-sm-3"><img src="{{asset('/imgs/') }}/{{$imgs->subimage}}" style="width:200px; height:200px;"></div>
