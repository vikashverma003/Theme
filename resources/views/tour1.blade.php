            ...
            <div class="row">
               	<div class="col-sm-12 main-section">
					<!-- <iframe src="https://www.google.com/maps/embed?pb=!4v1541827602396!6m8!1m7!1sCAoSLEFGMVFpcE5QUTg4X1lXVC1kbGtmdVZUQnpzU1lSZUNCd2tjeUk2QVRiZnF5!2m2!1d40.7525622!2d-73.9931179!3f251.62602693056294!4f-6.717542851739168!5f0.7820865974627469" width="100%" height="520" frameborder="0" style="border:0" allowfullscreen></iframe> -->
						...
						<img src="/imgs/hh_1544705860_jpg" style="width:100%; height:1100px; ">
				</div>
			 	<!-- COL-SM-12 END -->
			</div>
	</div>
            ...
            <div class="row">			
               	<div class="col-sm-6">
                    <div class="side_img">
							...
							<img src="imgs/himachal1_1544705860_jpg" style="height:200px;"> 
			 	...
			 	<div class="col-sm-6 ">
                    <div class="side_div">
							<div class="new_heading">
								<h2> <span class="span_main_1"></span>Shimla<span class="span_main_2"></span></h2>
							</div>
                            <p class="para_left">
			...
			<div class="row">			
			 	...
			 	<div class="col-sm-6 ">
                    <div class="side_div paddinG-side">
							<div class="new_heading">
								<h2> <span class="span_main_1"></span>Manali<span class="span_main_2 span_main_4"></span></h2>
							</div>
                   	...
                   	<div class="col-sm-6">
                    <div class="side_img">
							<img src="imgs/himachal4_1544705882_jpg" class="img-responsive grid_image">
                    </div>
				</div>
    ...
    <div class="pagination_div">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-3"><img src="imgs/chapslee_1544770594_jpg" class="img-responsive paginaton"></div>
				<div class="col-sm-3"><img src="imgs/chapslee4_1544770594_jpg" class="img-responsive paginaton"></div>
                <div class="col-sm-3"><img src="imgs/chapslee-a-trip-down_1544770594_jpg" class="img-responsive paginaton"></div>
                </div>
			</div>
			<!-- <div class="row">
                  <div class="main_desti_img clearfix">
